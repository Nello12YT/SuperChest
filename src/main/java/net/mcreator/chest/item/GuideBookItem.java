...
public class GuideBookItem extends ChestModElements.ModElement {
	@ObjectHolder("chest:guide_book")
	public static final Item block = null;

	public GuideBookItem(ChestModElements instance) {
		super(instance, 8);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("libro"));
		}
	}
}
